    ...
    <ScrollColumn>
      <section style={pcss('min-height:60vh;display:grid;place-items:center;text-align:center;padding:32px')}>
        <div>
          ...
          <div style={pcss("margin-top:16px;font:800 10px 'Nunito',sans-serif;letter-spacing:.14em;color:var(--pki,#E86F87)")}>HALAMAN TIDAK DITEMUKAN</div>
          ...
          <p style={pcss("max-width:44ch;margin:12px auto 0;font:600 14px/1.65 'Nunito',sans-serif;color:var(--mut,#A99A9E)")}>Halaman ini mungkin sudah pindah. Cerita kalian tetap aman di ruang utama.</p>
          <button
            type="button"
